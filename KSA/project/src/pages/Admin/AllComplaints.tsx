...
const AllComplaints: React.FC = () => {
  ...
  const { complaints, loading, loadComplaints, assignComplaint, total } = useComplaints({
    autoLoad: false
  });
  ...
  const handleAssignComplaint = async (complaintId: string, technicianId: string) => {
    await assignComplaint(complaintId, technicianId);
  };
              ...
              {complaints.map((complaint) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500 mb-4">
                        <span>Customer: {complaint.createdBy.name} ({complaint.createdBy.email})</span>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    <div className="flex items-center space-x-4">
                      {complaint.assignedTo ? (
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="font-medium text-gray-800">{complaint.assignedTo.name}</span>
                        </div>
                      ) : (
                    ...
                    {!complaint.assignedTo && technicians.length > 0 && (
